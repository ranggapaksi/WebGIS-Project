...
// Di Vercel, folder 'public' ditangani secara otomatis, sehingga baris ini tidak wajib.
// app.use(express.static(path.join(__dirname, 'public')));

// CEK DATABASE URL
if (!process.env.DATABASE_URL) {
    console.error("⛔ FATAL ERROR: DATABASE_URL KOSONG! Pastikan sudah diisi di menu Variables Vercel.");
}
...
// Modifikasi untuk Vercel: Mengubah app.listen menjadi module.exports
module.exports = app;
